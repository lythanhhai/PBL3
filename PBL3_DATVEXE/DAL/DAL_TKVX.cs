...
namespace PBL3_DATVEXE.DAL
{
    class DAL_TKVX
    {
        ...
        {
            string sql = "select [MVH_07_DEMO].[dbo].[Order].id_order,Vehicle.name ,departure,arrival,DetailRoute.date,DetailRoute.time_start,numberTicket,total_price,date_order,info_person.name as name1,info_person.phone from Vehicle, DetailRoute, Route, orderSeat, Seat, info_person,[MVH_07_DEMO].[dbo].[Order],[MVH_07_DEMO].[dbo].[login] where Route.id_route = DetailRoute.id_route and Vehicle.id_vehicle = DetailRoute.id_vehicle and Vehicle.id_vehicle = Seat.id_vehicle and DetailRoute.id_detRoute = orderSeat.id_detRoute and Seat.id_seat = orderSeat.id_seat and orderSeat.id_order = [MVH_07_DEMO].[dbo].[Order].id_order and [MVH_07_DEMO].[dbo].[Order].id_person = info_person.id_person and info_person.id_login =[MVH_07_DEMO].[dbo].[login].id_login and [MVH_07_DEMO].[dbo].[Order].id_order = '" + id_order+ "' and permission != '1'";
        ...
        {
            string sql = "select [MVH_07_DEMO].[dbo].[Order].id_order,Vehicle.name ,departure,arrival,DetailRoute.date,DetailRoute.time_start,numberTicket,total_price,date_order,info_person.name as name1,info_person.phone from Vehicle, DetailRoute, Route, orderSeat, Seat, info_person,[MVH_07_DEMO].[dbo].[Order],[MVH_07_DEMO].[dbo].[login] where Route.id_route = DetailRoute.id_route and Vehicle.id_vehicle = DetailRoute.id_vehicle and Vehicle.id_vehicle = Seat.id_vehicle and DetailRoute.id_detRoute = orderSeat.id_detRoute and Seat.id_seat = orderSeat.id_seat and orderSeat.id_order = [MVH_07_DEMO].[dbo].[Order].id_order and [MVH_07_DEMO].[dbo].[Order].id_person = info_person.id_person and info_person.id_login =[MVH_07_DEMO].[dbo].[login].id_login and [MVH_07_DEMO].[dbo].[Order].id_order = '" + id_order + "'";
            List<Information_Order> L_ifor_order = new List<Information_Order>();
            foreach (DataRow i in DBHelper.Instance.executeNonQuery(sql).Rows)
            {
                Information_Order obj = new Information_Order
        ...
        {
            List<Information_Order> L_ifor_order = new List<Information_Order>();
            string sql= "select [MVH_07_DEMO].[dbo].[Order].id_order,Vehicle.name ,departure,arrival,DetailRoute.date,DetailRoute.time_start,numberTicket,total_price,date_order,info_person.name as name1,info_person.phone from Vehicle, DetailRoute, Route, orderSeat, Seat, info_person,[MVH_07_DEMO].[dbo].[Order],[MVH_07_DEMO].[dbo].[login] where Route.id_route = DetailRoute.id_route and Vehicle.id_vehicle = DetailRoute.id_vehicle and Vehicle.id_vehicle = Seat.id_vehicle and DetailRoute.id_detRoute = orderSeat.id_detRoute and Seat.id_seat = orderSeat.id_seat and orderSeat.id_order = [MVH_07_DEMO].[dbo].[Order].id_order and [MVH_07_DEMO].[dbo].[Order].id_person = info_person.id_person and info_person.id_login =[MVH_07_DEMO].[dbo].[login].id_login and date_order between '"+day1 +"' and '"+day2+"'";
            foreach (DataRow i in DBHelper.Instance.executeNonQuery(sql).Rows)
            {
                Information_Order obj = new Information_Order
                {
        ...
        {
            string sql = "select [MVH_07_DEMO].[dbo].[Order].id_order,Vehicle.name ,departure,arrival,DetailRoute.date,DetailRoute.time_start,numberTicket,total_price,date_order,info_person.name as name1,info_person.phone from Vehicle, DetailRoute, Route, orderSeat, Seat, info_person,[MVH_07_DEMO].[dbo].[Order],[MVH_07_DEMO].[dbo].[login] where Route.id_route = DetailRoute.id_route and Vehicle.id_vehicle = DetailRoute.id_vehicle and Vehicle.id_vehicle = Seat.id_vehicle and DetailRoute.id_detRoute = orderSeat.id_detRoute and Seat.id_seat = orderSeat.id_seat and orderSeat.id_order = [MVH_07_DEMO].[dbo].[Order].id_order and [MVH_07_DEMO].[dbo].[Order].id_person = info_person.id_person and info_person.id_login =[MVH_07_DEMO].[dbo].[login].id_login and info_person.permission != '1'";
            List<Information_Order> L_ifor_order = new List<Information_Order>();
            foreach (DataRow i in DBHelper.Instance.executeNonQuery(sql).Rows)
            {
                Information_Order obj = new Information_Order
